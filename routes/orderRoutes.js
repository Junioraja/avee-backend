...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const orderResult = await client.query(
            'INSERT INTO public.orders (user_id, total_amount, payment_method, status) VALUES ($1, $2, $3, $4) RETURNING id, order_date',
            [userId || null, totalAmount, paymentMethod || null, 'Pending'] // <-- Tambahkan 'Pending' di sini
        );
